pipeline {
    ...
    stages {
        ...
        stage("Deploy to K8S"){
            steps{
                withKubeConfig(caCertificate: '', clusterName: '', contextName: '', credentialsId: 'mitocode-akscluster', namespace: '', restrictKubeConfigAccess: false, serverUrl: '') {
